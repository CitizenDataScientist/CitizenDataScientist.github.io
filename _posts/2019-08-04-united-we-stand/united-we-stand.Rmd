...
preview: ../../images/post1_preview.svg
date: "`r Sys.Date()`"
output:
...
climate_window_new %>%
  ...
  scale_y_continuous(breaks = seq(-2.5, 1.5, 0.5), limits = c(-2.51, 1.51), expand = c(0, 0)) +
  labs(title = "Sentiment towards Climate Change at the UN General Debate",
       subtitle = "smoothed trend lines suggest specific patterns across clusters",
       caption = "one dot represents a speech, coloured by total mentions of Climate Change per country",
       x = "", y = "Polarity Score",
       fill = "total mentions") +
...
* sentiment towards climate change for the majority of countries at the UN General Debate (ranging from 6 to 50 mentions of the topic) follows a similar pattern, with a declining trend that has stabilized in recent years. Countries in this cluster make the most _polarizing_ statements;
* countries that recognize the relevance of the problem (51 to 100 total mentions) also issue _polarizing_ statements, having more pronounced trends than countires with fewer mentions of climate change;
...
This blogpost focused on the topic of climate change at the United Nations General Debate, covering the period from 1970 to 2015. Three research questions were answered through the analysis of the text corpus, establishing that:

* The **prevalence of the topic as changed drastically over time**, from the first mention professed in 1988 to being deemed the core theme of a debate session in 2007;
* Under the premise that the number of mentions of the topic is correlated with the degree of urgency a given country awards to climate change, **nations of the world are dissonant**. The numerous appeals made by endangered island nations are in **stark contrast** with the passive stance of countries like Saudi Arabia and Iran;
* The average **sentiment polarity** towards climate change has **declined** from marginally positive to neutral; every year a polarizing array of statements is made, with **grave concerns** being **intertwined** with calls for **cooperation and commitment** to Sustainable Development Goals;

Whilst the world appeared to be fragmented in 2015, a greater convergence is expected by the 2020.
In recent years the relevance of climate change in the mainstream media has experienced tangible growth, evolving into a truly global topic that commands the attention of politicians and the general public alike, dominating election programs and news outlets. Prominent figures have emerged and the cause has been championed by the younger generations. These recent developments are bound to have influenced the tone of the General Debate, the focus of a subsequent blogpost.
