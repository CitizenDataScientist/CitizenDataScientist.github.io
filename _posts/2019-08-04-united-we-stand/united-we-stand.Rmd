...
* **Norway, 1998** : : a _negative_ statement, with an overall score of **-0.912** computed as the average sentiment polarity assigned to each of the two sentences that comprise the _window of interest_;
...
* **Senegal, 2006** : : a _positive_ statement, which mentions the _Kyoto Protocol_, upheld at the time;

* **EU, 2011** : : the most _negative_ statement on record, scored as **-2.040**, where the contribution of the _negative_ setences largely overshadows that of the _positive_

* **Latvia, 2015** : : _positive_ statement, scored as **0.714**, which mentions the notorious UN framework convertion held in Paris in 2015, where the _Paris Agreement_ was adopted by consensus;
