...
base_url: "https://github.com/CitizenDataScientist/CitizenDataScientist.github.io" 
preview: "blob/master/images/post1_united_we_stand_preview.png"
date: "`r Sys.Date()`"
output: 
...
```{r climate_change_dots, echo=FALSE, fig.height=8, fig.width=16, warning=FALSE, dev='svg', layout="l-page", preview=TRUE}
