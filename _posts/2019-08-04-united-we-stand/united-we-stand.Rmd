...
description: |
 The hot topic of <strong>Climate Change</strong>, through the lens of the **UN General Debate**
author:
...
highlight_speeches <- c(3875, # PNG 1996 - short negative statement
                        5958, # VUT 2007 
                        6373, 
                        # 5868, # LAO 2007 - long positive statement
...
**SentimentR**’s algorithm was thus employed at sentence level on the _window of interest_ of every speech. The overall polarity score of statements with more than one sentence enclosed in the _window of interest_ was computed as the average value assigned to each sentence. Five instances were chosen to portray the unbounded score attributed to the remarks concerning this topic, professed on five different sessions of the General Debate:

* **Papua New Guinea, 1996** : : a _negative_ statement scored as **-0.498**, which mentions the _risk of extinction_ faced by island-countries in the south-western Pacific;

* **Maldives, 1998** : : a _negative_ statement, with an overall score of **-0.573** computed as the average sentiment polarity assigned to each of the four sentences that comprise the _window of interest_; 

* **Tuvalu, 2002** : : a _negative_ statement, with an overall score of **-0.573** computed as the average sentiment polarity assigned to each of the four sentences that comprise the _window of interest_; 
